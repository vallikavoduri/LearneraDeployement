              ...
              <div class="card-body">
               ...
               <c:if test="${not empty successMessage}">
                ...
                <form action="insertcourse" method="post" enctype="multipart/form-data" >
                  ...
                  <div class="form-group">
                    <label class="form-label" for="desc">Course Description</label>
					<textarea class="form-control" id="desc" name="desc" rows="4" placeholder="Enter course description" required></textarea>
                  </div>
                   <div class="form-group">
                    <label class="form-label" for="duration">Course Duration</label>
                    <input type="number" class="form-control" placeholder="Title" id="duration" name="duration" required/>
                  </div>
                  <div class="form-group">
...
<!-- Main wrapper end -->
  <!-- Scripts -->
    ...
    <c:if test="${not empty successMessage}">
        hideElement('successMessage', 5000);
    </c:if>

    <c:if test="${not empty errorMessage}">
        hideElement('errorMessage', 5000);
    </c:if>
</script>
    </body>
</html>
