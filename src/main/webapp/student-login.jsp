          ...
          <div class="col-lg-5 col-md-6">
            <div class="card mb-0 h-auto">
              <div class="card-body">
                ...
                <h4 class="text-center mb-4">Login as Student</h4>
                <form action="checkStudentLogin" method="post">
                  <div class="form-group">
                    <label class="form-label" for="semail">Email</label>
                    <input class="form-control" type="text" id="semail" name="semail" required/>
                  </div>
                  <div class="mb-4 position-relative">
                  <label class="form-label" for="spwd">Password</label>
                    <input class="form-control" type="text" id="spwd" name="spwd" required/>
