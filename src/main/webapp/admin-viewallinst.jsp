                          ...
                          <tbody>
                           <c:forEach items="${instructorlist}" var="i">
                            <tr>
                              ...
                              <td>
                                <c:out value="${i.email}"/></a
                                >
                              </td>
                              <td>
								<c:out value="${i.qualification}"/>
                              </td>
                              ...
                              &nbsp;&nbsp;
                   				<a class="action-btn accept-btn" href='<c:url value="updateinststatus?id=${i.id}&status=Approved"></c:url>'>
								   <span class="btn-icon">&#10004;</span> 
								</a>&nbsp;&nbsp;&nbsp;
								<a class="action-btn reject-btn" href='<c:url value="updateinststatus?id=${i.id}&status=Rejected"></c:url>'>
								   <span class="btn-icon">&#10006;</span> 
								</a>
							  </td>
                              
                              <td>
								<a href="updateInstructor?id=${i.id}" class="btn btn-xs sharp btn-primary"><i class="fa fa-pencil"></i></a>
                                <a class="btn btn-xs sharp btn-danger" onclick="confirmDelete('<c:url value='deleteinst?id=${i.id}'/>')"><i class="fa fa-trash"></i></a>
                              </td>
                            </tr>
                            </c:forEach>
