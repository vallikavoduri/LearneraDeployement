...
<html lang="en">
  <head>
    ...
    <meta
      property="og:title"
      content="EduMin - Education Admin Dashboard Template | dexignlabs"
    />
    <meta
    ...
    <meta
      property="og:image"
      content="https://edumin.dexignlab.com/xhtml/social-image.png"
    />
          ...
          <div class="col-lg-5 col-md-6">
            <div class="card mb-0 h-auto">
              <div class="card-body"z>
               	<center><a href="admin-dashboard" class="brand-logo">
				...
				<form method="post" action="checkAdminLogin">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Username" id="auname" name="auname" required />
                  </div>
                  <div class="mb-4 position-relative">
                    <label for="apwd">Password</label>
                    <input type="password" class="form-control" placeholder="Enter Password" id="apwd" name="apwd" required />
                  ...
                  <div
                    class="form-row d-flex flex-wrap justify-content-between mt-4 mb-2"
                  >
                    <div class="form-group">
                    ...
                    <div class="form-group ms-2">
                      <a class="btn-link" href="page-forgot-password.html"
                        >Forgot Password?</a
                      >
                    </div>
                  </div>
