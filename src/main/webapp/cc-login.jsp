          ...
          <div class="col-lg-5 col-md-6">
            <div class="card mb-0 h-auto">
              <div class="card-body">
                ...
                <h4 class="text-center mb-4" font-family="GillSans">Login as CC</h4>
                
                <form  method="post" action="checkCCLogin">
                  ...
                  <div class="mb-4 position-relative">
                    ...
                    <input type="password" class="form-control" placeholder="Password" id="cpwd" name="cpwd" required />
